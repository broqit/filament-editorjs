    ...
    return {
      ...
      init: function init() {
        ...
        if (this.tools.includes('image')) {
          var imageToolConfig = toolsOptions.hasOwnProperty('image') ? toolsOptions.image : {};
          var imageToolDefaultConfig = {
            uploader: {
          ...
          enabledTools.image = {
            ...
            config: _objectSpread(_objectSpread({}, imageToolDefaultConfig), imageToolConfig)
          };
        }
        if (this.tools.includes('image-gallery')) {
          var imageGalleryToolConfig = toolsOptions.hasOwnProperty('image-gallery') ? toolsOptions['image-gallery'] : {};
          var imageGalleryToolDefaultConfig = {
            uploader: {
              uploadByFile: function uploadByFile(file) {
                return _this2.uploadImage(file);
              },
          ...
          enabledTools.imageGallery = {
            ...
            config: _objectSpread(_objectSpread({}, imageGalleryToolDefaultConfig), imageGalleryToolConfig)
          };
        }
